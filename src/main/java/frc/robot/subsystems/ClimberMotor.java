...
private CANSparkMax innerMotor;
...
innerMotor = new CANSparkMax(0, MotorType.kBrushless);
...
outerMotor = new CANSparkMax(5, MotorType.kBrushless);
...
outerMotor.burnFlash();
    ...
    public void runInnerMotor(double setpoint) {
        innerMotor.set(setpoint);
    }
    public void runOuterMotor(double setpoint) {
        outerMotor.set(setpoint);
    }
